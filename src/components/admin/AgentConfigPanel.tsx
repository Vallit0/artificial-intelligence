...
const KNOWN_AGENTS = [
  ...
  { secretName: "ELEVENLABS_AGENT_PROSPECTING_FAMILIA_STAND", label: "Prospeccion: Familia en Stand" },
  { secretName: "ELEVENLABS_AGENT_PROSPECTING_PROFESIONAL_CAMINANDO", label: "Prospeccion: Profesional Caminando" },
  { secretName: "ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_1", label: "Prospeccion: Senora Compras Stand 1" },
  { secretName: "ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_2", label: "Prospeccion: Senora Compras Stand 2" },
  { secretName: "ELEVENLABS_AGENT_PROSPECTING_PAREJA_CEMENTERIO", label: "Prospeccion: Pareja en Cementerio" },
