...
export const config = {
  ...
  elevenlabs: {
    ...
    agentProspectingFamiliaStand: process.env.ELEVENLABS_AGENT_PROSPECTING_FAMILIA_STAND || '',
    agentProspectingProfesionalCaminando: process.env.ELEVENLABS_AGENT_PROSPECTING_PROFESIONAL_CAMINANDO || '',
    agentProspectingSenoraCompras1: process.env.ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_1 || '',
    agentProspectingSenoraCompras2: process.env.ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_2 || '',
    agentProspectingParejaCementerio: process.env.ELEVENLABS_AGENT_PROSPECTING_PAREJA_CEMENTERIO || '',
