...
const envSchema = z.object({
  ...
  ELEVENLABS_AGENT_PROSPECTING_FAMILIA_STAND: optionalString,
  ELEVENLABS_AGENT_PROSPECTING_PROFESIONAL_CAMINANDO: optionalString,
  ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_1: optionalString,
  ELEVENLABS_AGENT_PROSPECTING_SENORA_COMPRAS_2: optionalString,
